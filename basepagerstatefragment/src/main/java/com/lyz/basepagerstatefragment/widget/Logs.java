...
//            Log.e(sApplicationTag, Thread.currentThread().getStackTrace()[fangdao2].getClassName());
//            Log.e(sApplicationTag, Thread.currentThread().getStackTrace()[fangdao2].getMethodName());
...
//        }
//        int pos = Modifier.isStatic(cm.getModifiers()) ? 0 : fangdao1;
